...
function init() { /* función inicial */
    $('#listadoRegistrosApp').hide();
    $('#listadoRegistrosWeb').hide();
...
$("#btnBuscar").click(function () {
    if ($("#txtFechaInicio").val() == "" || $("#txtFechaFin").val() == "" || $("#txtSegmento").val() == "") {
        bootbox.alert("Seleccione los filtro para continuar");
    } else {
        ...
        if ($("#txtSegmento").val() == "Banca Digital App") {
            $('#listadoRegistrosApp').show();
            $('#listadoRegistrosWeb').hide();

            tabla = $('#tblListadoApp').dataTable({
                ...
                "ajax": {
                    url: '../ajax/reportesC.php?action=reportBGRDigitalApp',
                    data: {
        ...
        } else if ($("#txtSegmento").val() == "Banca Digital Web") {
            $('#listadoRegistrosApp').hide();
            $('#listadoRegistrosWeb').show();

            tabla = $('#tblListadoWeb').dataTable({
                "lengthMenu": [5, 10, 25, 75, 100], //mostramos el menú de registros a revisar
                "aProcessing": true, /* activa el procesamiento de DataTables */
                "aServerSide": true, /* Paginación y filtrado realizado por el servidor */
                dom: '<Bl<f>rtip>', //Definimos los elementos del control de tabla
                ...
                "ajax": {
                    url: '../ajax/reportesC.php?action=reportBGRDigitalWeb',
                    data: {
                        txtFechaInicio: txtFechaInicio,
                        txtFechaFin: txtFechaFin
                    },
...
$("#btnBuscar1").click(function () {
    if ($("#txtFechaInicio1").val() == "" || $("#txtFechaFin1").val() == "") {
        ...
        tabla = $('#tblListado1').dataTable({
            ...
            "ajax": {
                url: '../ajax/reportesC.php?action=reportBGRNetApp',
                data: {
                    txtFechaInicio: txtFechaInicio,
                    txtFechaFin: txtFechaFin
                },
...
$("#btnBuscar2").click(function () {
    if ($("#txtFechaInicio2").val() == "" || $("#txtFechaFin2").val() == "") {
        ...
        tabla = $('#tblListado2').dataTable({
            ...
            "ajax": {
                url: '../ajax/reportesC.php?action=reportBGRNetWeb',
                data: {
                    txtFechaInicio: txtFechaInicio,
                    txtFechaFin: txtFechaFin
                },
...
$("#btnBuscar3").click(function () {
    if ($("#txtFechaInicio3").val() == "" || $("#txtFechaFin3").val() == "") {
        ...
        tabla = $('#tblListado3').dataTable({
            ...
            "ajax": {
                url: '../ajax/reportesC.php?action=reportCallCenterV2',
                data: {
                    txtFechaInicio: txtFechaInicio,
                    txtFechaFin: txtFechaFin
                },
