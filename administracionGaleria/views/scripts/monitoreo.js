...
function limpiar_formulario() {
    $("#txtObservaciones").attr('required', false);
    $("#txtObservaciones").attr('readonly', true);
    $('#txtEstadoMonitoreo').val("");
...
function mostrar_uno(Id) {
    $('#calificacionesModal').on('shown.bs.modal', function () {
        ...
        $.post("../ajax/monitoreoC.php?action=selectById", {Id: Id}, function (datos, estado) {
            ...
            $('#txtManejoGestion').val(datos.ManejoGestion);
            $('#txtMejoras').val(datos.Mejoras);
...
$("#txtEstadoMonitoreo").change(function () {
    var txt = $("#txtEstadoMonitoreo").val();
    if (txt != 'AUDITADO') {
        $("#txtObservaciones").attr('required', true);
...
function guardar_datos(e) {
    ...
    var txt = $("#txtEstadoMonitoreo").val();
    if (txt == '') {
        bootbox.alert("Debe colocar un estado de monitoreo para continuar!...");
    } else {
