...
$("#btnBuscar").click(function () {
    ...
    tabla = $('#tblListado').dataTable({
        ...
        "ajax": {
            url: '../ajax/frontAreasC.php?action=selectAllLealtadFiltros',
            data: {
                txtAreas: txtAreas,
    ...
    tabla1 = $('#tblListado1').dataTable({
        ...
        "ajax": {
            url: '../ajax/frontAreasC.php?action=selectAllPilaresFiltros',
            data: {
                txtAreas: txtAreas,
                txtFechaInicio: txtFechaInicio,
                txtFechaFin: txtFechaFin,
    ...
    $.ajax({
        type: "POST",
        url: '../ajax/frontAreasC.php?action=tacometroNPSFiltros',
        data: {
            txtAreas: txtAreas,
            txtFechaInicio: txtFechaInicio,
            txtFechaFin: txtFechaFin
    ...
    $.ajax({
        type: "POST",
        url: '../ajax/frontAreasC.php?action=tacometroINSFiltros',
        data: {
            txtAreas: txtAreas,
            txtFechaInicio: txtFechaInicio,
            txtFechaFin: txtFechaFin,
    ...
    $.ajax({
        type: "POST",
        url: '../ajax/frontAreasC.php?action=tacometroCESFiltros',
        data: {
            txtAreas: txtAreas,
            txtFechaInicio: txtFechaInicio,
            txtFechaFin: txtFechaFin,
    ...
    $.ajax({
        type: "POST",
        url: '../ajax/frontAreasC.php?action=tacometroVisionFiltros',
        data: {
            txtAreas: txtAreas,
            txtFechaInicio: txtFechaInicio,
            txtFechaFin: txtFechaFin,
