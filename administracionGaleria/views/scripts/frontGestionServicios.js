...
function init() { /* función inicial */
    ...
    $.ajax({
        type: "POST",
        url: '../ajax/frontPrincipalC.php?action=tacometroNPSServicios',
        success: function (r) {
            if (r >= 85.00 && r <= 100) {
    ...
    $.ajax({
        type: "POST",
        url: '../ajax/frontPrincipalC.php?action=tacometroINSServicios',
        success: function (r) {
            if (r >= 80.00 && r <= 100) {
    ...
    $.ajax({
        type: "POST",
        url: '../ajax/frontPrincipalC.php?action=tacometroCESServicios',
        success: function (r) {
            if (r >= 0.00 && r <= 14.99) {
    ...
    $.ajax({
        type: "POST",
        url: '../ajax/frontPrincipalC.php?action=tacometroVisionServicios',
        success: function (r) {
            if (r >= 80.00 && r <= 100) {
...
function mostrar_todos() {
    tabla = $('#tblListado').dataTable({
        ...
        "ajax": {
            url: '../ajax/frontPrincipalC.php?action=selectAllLealtadServicios',
            type: "get",
            dataType: "json",
            error: function (e) {
...
function mostrar_todos1() {
    tabla1 = $('#tblListado1').dataTable({
        ...
        "ajax": {
            url: '../ajax/frontPrincipalC.php?action=selectAllPilaresServicios',
            type: "get",
            dataType: "json",
            error: function (e) {
                console.log(e.responseText);
