                        ...
                        <div class="x_panel text-dark border-dark">
                            <div class="x_title border-dark">
                                <div class="col-md-11 col-sm-11">
                                    <h2>Gestión de oficinas (Búsquedas)</h2>
                                </div>
                            ...
                            <div id="filtros" class="x_content">
                                ...
                                <div id="divTipoCliente" class="col-md-1 col-sm-1">
...
<script src="scripts/frontGestionOficinas.js" type="text/javascript"></script>