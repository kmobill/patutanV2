...
<div class="flex flex-col justify-center items-center">
  <section class="vistaSlider | w-full flex flex-col justify-center items-center">
    <section class="">
      <img class="content-[url('../assets/images/credito/emergente/barraSm.png')] md:content-[url('../assets/images/credito/emergente/barra.png')]" alt="ahorro chiquiahorro">
    </section>
  </section>
  <div class="w-[min(1400px,80%)]">
    <section class="vistaContent | flex flex-col items-center bg-cover bg-no-repeat" style="background-image: url('../assets/images/ahorros/fondo.png');">
      ...
      <div class="flex flex-col lg:flex-row gap-10 md:gap-0 items-center w-full my-5">
        <section class="flex flex-col items-center justify-center text-[#052b9a] w-4/5">
          <div class="bg-slate-100 border-2 border-[#052b9a] rounded-md px-8 py-1.5 w-11/12 hover:scale-105 ease-in-out transition duration-300">
            <p class=" leading-6 sm:leading-8 md:leading-10 text-xl lg:text-2xl">
              Esta es la solución a los imprevistos que surgen con el tiempo, cualquier gasto relacionado a la salud, educación, viajes, etc.
            </p>
          </div>
          <div class="flex md:flex-row flex-col gap-16">
            <div class="flex flex-col gap-3">
              ...
              <img class="w-[400px] hover:scale-105 ease-in-out transition duration-300" src="../assets/images/credito/emergente/caracteristicas.png" alt="">
            </div>
            <div class="flex flex-col justify-center items-center">
