...
<div class="">
  <section class="vistaSlider | w-full flex flex-col justify-center items-center">
    <section class="">
      <img class="content-[url('../assets/images/ahorros/corporativo/barraCorporativoMin.png')] md:content-[url('../assets/images/ahorros/corporativo/barraCorporativo.png')]" alt="ahorro programado">
    </section>
  </section>
  <section class="vistaContent | flex flex-col items-center bg-cover bg-no-repeat" style="background-image: url('../assets/images/ahorros/fondo.png');">
    ...
    <div class="flex flex-col md:flex-row gap-10 md:gap-0 items-center w-full text-xl sm:text-2xl my-5">
      <section class="flex flex-col items-center justify-center text-[#052b9a] w-4/5 2xl:w-1/2">
        <div class="bg-slate-100 border-2 border-[#052b9a] rounded-md px-5 py-1.5 w-[min(550px,90%)] hover:scale-105 ease-in-out transition duration-300">
          <p>
            El ahorro corporativo está destinado a las personas que quieran ser parte activa de la comunidad y de la cooperativa, convirtiéndose en un socio que apoya a su pueblo dando trabajo y aportando a la economía interna del país.
          </p>
        </div>
        ...
        <div class="bg-slate-100 border-2 border-[#052b9a] rounded-md pr-1 pl-7 py-1.5 w-[min(550px,90%)] hover:scale-105 ease-in-out transition duration-300">
          <ul class="pl-2 flex flex-col list-outside list-disc">
            <li>Un mínimo de interés mucho más elevado, pero con mayores prestaciones</li>
            <li>Hasta un 7.5% de intereses</li>
