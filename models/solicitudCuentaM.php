...
class solicitudCuentaM
{
  ...
  function envioCorreos($nombre, $telefono, $Tmstmp, $correo, $txtObs, $principalMail, $copiaMail, $CC1)
  {
    $oMail = new PHPMailer();
    $oMail->isSMTP();
    ...
    $oMail->setFrom("info@coacsantarosadepatutan.fin.ec", "SOLICITUD DE CREACION DE CUENTA");
    $oMail->addAddress("$principalMail");
    $oMail->addAddress("$copiaMail");
    $oMail->addCC("$CC1");
    $oMail->Subject = "CLIENTE $nombre SOLICITA CREAR CUENTA";
