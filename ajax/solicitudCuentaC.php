...
require '../models/solicitudCuentaM.php';
$solicitudCuenta = new solicitudCuentaM();
...
switch ($_GET["action"]) {
  case 'envioMail':
    ...
    $envioMail = $solicitudCuenta->envioCorreos($nombre, $telefono, $Tmstmp, $correo, $txtObs, $principalMail, $copiaMail, $CC1);
    echo ($envioMail);
    break;
}
